    ...
    (cond ((or (and (has-value? d1) (= (get-value d1) 0))
          ...
          ((and (has-value? d1) (has-value? d2))
           (set-value! div
                       ...
                       me))
          ((and (has-value? div) (has-value? d1))
           (set-value! d2
                       (/ (get-value d1) (get-value div))
                       me))
          ((and (has-value? div) (has-value? d2))
           (set-value! d1
                       (* (get-value d2) (get-value div))
                       me))))
  (define (process-forget-value)
    (forget-value! div me)
    (forget-value! d1 me)
